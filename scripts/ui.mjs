...
(function(){
  ...
  function openSheet(el){
    ...
    if(body){
      // A sheet reopens at the top, never where it was left, or its heading
      // and first options sit above the fold looking as though they are
      // missing. This must run AFTER showModal: a closed <dialog> is
      // display:none, and scrollTop on a display:none element does nothing.
